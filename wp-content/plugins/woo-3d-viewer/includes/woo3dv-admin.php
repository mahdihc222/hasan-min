			...
			<?php    wp_nonce_field( 'update', 'woo3dv_save_settings' ); ?>
				...
				<table>
					...
					<tr>
						...
						<td>X<input size="3" type="text"  placeholder="<?php esc_attr_e( 'X', 'woo3dv' );?>" name="woo3dv_settings[default_rotation_x]" value="<?php echo esc_attr($settings['default_rotation_x']);?>">&deg;  Y<input size="3"  type="text" placeholder="<?php esc_attr_e( 'Y', 'woo3dv' );?>" name="woo3dv_settings[default_rotation_y]" value="<?php echo esc_attr($settings['default_rotation_y']);?>">&deg;</td>
					</tr>
					<tr>
					...
					<tr>
						<td><?php esc_html_e( 'Show Toobar', 'woo3dv' );?></td>
					...
					<tr>
						<td><?php esc_html_e( 'Enable Controls (Zoom/Pan)', 'woo3dv' );?></td>
						<td><input type="hidden" name="woo3dv_settings[enable_controls]" value="0"><input type="checkbox" name="woo3dv_settings[enable_controls]" <?php if ($settings['enable_controls']=='on') echo 'checked';?>>
							<img class="woo3dv-tooltip" data-title="<?php esc_attr_e( 'Enables manual controls (zoom/pan) by mouse or swipe', 'woo3dv' );?>" src="<?php echo esc_url(plugins_url( 'woo-3d-viewer/images/question.png' )); ?>">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="hidden" name="woo3dv_settings[show_shadow]" value="0"><input type="checkbox" name="woo3dv_settings[show_shadow]" <?php if ($settings['show_shadow']=='on') echo 'checked';?>></td>
					</tr>
					<tr>
