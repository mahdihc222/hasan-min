...
Rule of a thumb: if a model is vieweable - it's downloadable.
The only way to protect your models offered by the plugin is to convert them to GIF or WEBM.
After conversion the source models should be removed manually through WordPress Media Library.
...
* Product page - fixed canvas vertical height on fullscreen exit
